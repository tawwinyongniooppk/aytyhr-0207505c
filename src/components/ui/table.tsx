...
const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => <thead ref={ref} className={cn("bg-muted/45 [&_tr]:border-b", className)} {...props} />,
);
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
        "border-b border-border/70 transition-colors duration-150 data-[state=selected]:bg-selected hover:bg-muted/45", className)}
      {...props}
    />
  ),
);
